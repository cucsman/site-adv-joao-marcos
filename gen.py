...
'wa_btn':'WhatsApp 24h','wa_bar':'Plantão 24h — Falar agora','logo_tag':'Advocacia e Consultoria',
...
# index
'ix_title':'Advogado Criminalista e Tributarista em São Paulo | João Marcos A. Batista — Plantão 24h',
'ix_desc':'Defesa criminal e tributária de alta complexidade em São Paulo. Do flagrante aos Tribunais Superiores, da autuação fiscal ao CARF. Plantão 24h.',
...
'hero_badge':'Plantão 24 horas para flagrantes e urgências','hero_cta1':'Falar com um advogado agora','hero_cta2':'Áreas de atuação',
...
'urg_p2':'Nosso plantão atende a qualquer hora, todos os dias. Um advogado orienta a família, acompanha a lavratura do flagrante e atua imediatamente na audiência de custódia.',
'urg_cta':'Chamar o plantão 24h','urg_card':'O que fazer agora',
'urg_steps':['Não preste declarações sem a presença de um advogado.','Reúna documentos e informações básicas sobre a ocorrência.','Chame nosso plantão — orientamos os próximos passos na hora.'],
...
'cr_band_h':'Precisa de defesa criminal?','cr_band_p':'Plantão 24 horas, todos os dias. Sigilo absoluto desde a primeira conversa.','cr_band_b':'Falar com um advogado agora','cr_band_wa':'Ol%C3%A1%2C%20preciso%20de%20defesa%20criminal.',
# tributario page
...
# internacional page
'il_title':'Atuação Internacional — Lista de Advogados da Embaixada dos EUA | JMB Advocacia','il_desc':'Defesa criminal de estrangeiros no Brasil. Escritório na lista de advogados da Embaixada dos EUA. Atendimento em inglês e espanhol, 24h.',
...
'il_how_box':'Plantão 24h para prisões: um advogado responde imediatamente, explica a situação no seu idioma e atua na audiência de custódia — que acontece em até 24 horas após a prisão no Brasil.',
...
'il_band_h':'Preso ou investigado no Brasil?','il_band_p':'Atendemos 24/7. Um advogado criminalista fala com você no seu idioma e explica exatamente os próximos passos.','il_band_b':'WhatsApp — atendimento imediato',
# equipe page
...
'eq_bio2':'Pós-graduado em Direito Penal Econômico pela FGV/SP e em Finanças, Investimentos e Banking pela PUC/RS. Assessor de Prerrogativas da OAB/SP, membro do IDDD, associado ao IBCCRIM e membro do Instituto Brasileiro de Planejamento e Tributação.',
...
'wa_btn':'WhatsApp 24/7','wa_bar':'24/7 line — Talk now','logo_tag':'Attorneys at Law',
...
'ix_title':'Criminal & Tax Lawyer in São Paulo, Brazil | João Marcos A. Batista — 24/7','ix_desc':'High-stakes criminal and tax defense in Brazil. From arrest to the Superior Courts. U.S. Embassy attorney list. English and Spanish spoken. 24/7.',
...
'hero_badge':'24/7 emergency line for arrests','hero_cta1':'Talk to a lawyer now','hero_cta2':'Practice areas',
...
'urg_p2':'Our emergency line answers any time, every day. A lawyer guides the family, follows the arrest paperwork and acts immediately at the custody hearing.',
'urg_cta':'Call the 24/7 line','urg_card':'What to do now',
'urg_steps':['Do not give any statement without a lawyer present.','Gather basic documents and information about the incident.','Call our emergency line — we will guide you immediately.'],
...
'in_en':'Arrested or under investigation in Brazil? We answer 24/7 and speak English and Spanish.','in_a':'International clients →',
...
'cr_band_h':'Need criminal defense in Brazil?','cr_band_p':'24/7, every day. Strict confidentiality from the first conversation. English and Spanish spoken.','cr_band_b':'Talk to a lawyer now','cr_band_wa':'Hello%2C%20I%20need%20criminal%20defense%20in%20Brazil.',
...
'il_title':'Criminal Lawyer for Foreigners in Brazil — U.S. Embassy Attorney List | JMB Law','il_desc':'Criminal defense for foreign nationals in Brazil. U.S. Embassy attorney list. English and Spanish spoken. 24/7 emergency line.',
...
'il_how_box':'24/7 emergency line for arrests: a lawyer responds immediately, explains the situation in English, and acts at the custody hearing — which happens within 24 hours of an arrest in Brazil.',
...
'il_band_h':'Arrested or under investigation in Brazil?','il_band_p':'We answer 24/7. A criminal lawyer will speak with you in English and explain exactly what happens next.','il_band_b':'WhatsApp — English spoken',
...
'eq_bio2':'Graduate degrees in Economic Criminal Law (FGV/SP) and in Finance, Investments and Banking (PUC/RS). Prerogatives Advisor at the São Paulo Bar (OAB/SP), member of IDDD, associate of IBCCRIM, and member of the Brazilian Institute of Tax Planning.',
...
'wa_btn':'WhatsApp 24h','wa_bar':'Guardia 24h — Hablar ahora','logo_tag':'Abogados',
...
'ix_title':'Abogado Penalista y Tributarista en São Paulo, Brasil | João Marcos A. Batista — 24h','ix_desc':'Defensa penal y tributaria de alta complejidad en Brasil. De la detención a los Tribunales Superiores. Lista de abogados de la Embajada de EE.UU. Atención en español. 24h.',
...
'hero_badge':'Guardia 24 horas para detenciones y urgencias','hero_cta1':'Hablar con un abogado ahora','hero_cta2':'Áreas de práctica',
...
'urg_p2':'Nuestra guardia atiende a cualquier hora, todos los días. Un abogado orienta a la familia, acompaña el registro de la detención y actúa de inmediato en la audiencia de custodia.',
'urg_cta':'Llamar a la guardia 24h','urg_card':'Qué hacer ahora',
'urg_steps':['No declare sin la presencia de un abogado.','Reúna documentos e información básica sobre el hecho.','Llame a nuestra guardia — le orientamos de inmediato.'],
...
'in_en':'¿Detenido o investigado en Brasil? Atendemos 24/7 y hablamos español e inglés.','in_a':'Clientes internacionales →',
...
'cr_band_h':'¿Necesita defensa penal en Brasil?','cr_band_p':'Guardia 24 horas, todos los días. Confidencialidad absoluta desde la primera conversación. Hablamos español.','cr_band_b':'Hablar con un abogado ahora','cr_band_wa':'Hola%2C%20necesito%20defensa%20penal%20en%20Brasil.',
...
'il_title':'Abogado Penalista para Extranjeros en Brasil — Lista de la Embajada de EE.UU. | JMB','il_desc':'Defensa penal de extranjeros en Brasil. Lista de abogados de la Embajada de EE.UU. Atención en español. Guardia 24h.',
...
'il_how_box':'Guardia 24h para detenciones: un abogado responde de inmediato, explica la situación en su idioma y actúa en la audiencia de custodia — que ocurre dentro de las 24 horas de la detención en Brasil.',
...
'il_band_h':'¿Detenido o investigado en Brasil?','il_band_p':'Atendemos 24/7. Un abogado penalista hablará con usted en español y le explicará exactamente los próximos pasos.','il_band_b':'WhatsApp — hablamos español',
...
'eq_bio2':'Posgrados en Derecho Penal Económico (FGV/SP) y en Finanzas, Inversiones y Banca (PUC/RS). Asesor de Prerrogativas del Colegio de Abogados de São Paulo, miembro del IDDD, asociado al IBCCRIM y miembro del Instituto Brasileño de Planificación Tributaria.',
